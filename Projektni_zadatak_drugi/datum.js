...
function izracunajRazlikuDatuma(d1,vrijemeSada){
	...
	else if(razlika/1000>=60 && razlika/(1000*60)<60){broj=parseInt(razlika/(1000*60));  if(broj%10==1) prijeKoliko="prije "+broj+" minutu";else if(broj%10>=2 && broj%10<=4) prijeKoliko="prije "+broj+" minute";else prijeKoliko="prije "+broj+" minuta"; }
